...
#ifndef __CPU_PRED_GLOBAL_HIST_HH__
#define __CPU_PRED_GLOBAL_HIST_HH__
...
#include "cpu/pred/bpred_unit.hh"
#include "params/GlobalHistBP.hh"  // made automatically by scons


class GlobalHistBP : public BPredUnit
{
  private:
  ...
  public:
     ...
     * Constructor
     */
    GlobalHistBP(const GlobalHistBPParams *params);
...
#endif // __CPU_PRED_GLOBAL_HIST_HH__
